...
embedding_pkl_path = f"{data_path}interaction-datasets/{organism}_protbert_embeddings.pkl"
...
# Model
model = TransformerGO_matmul(EMB_DIM, 8, 3, 4*EMB_DIM, 0.2, using_esm2=False).to(device)
